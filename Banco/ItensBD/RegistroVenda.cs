using Banco.ModeloXML.PartesProcesso;
using Banco.ModeloXML.PartesProcesso.PartesNFe;
using Banco.ModeloXML.PartesProcesso.PartesNFe.PartesDetalhes;
using Banco.ModeloXML.PartesProcesso.PartesNFe.PartesDetalhes.PartesTransporte;
using System;
