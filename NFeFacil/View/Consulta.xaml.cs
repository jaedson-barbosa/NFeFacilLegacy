...
namespace NFeFacil.View
{
    ...
    public sealed partial class Consulta : Page, IEsconde
    {
        ...
        {
            InitializeComponent();
            Propriedades.Intercambio.SeAtualizar(Telas.Consulta, Symbol.Zoom, nameof(Consulta));
        ...
        private async void btnAnalisar_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var resp = await Gerenciador.ConsultarAsync(codigo, (cmbUF.SelectedItem as Estado).Codigo);
                DataContext = resp;
            }
